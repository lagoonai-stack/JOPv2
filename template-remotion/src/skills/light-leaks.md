...
**NEVER** use `<LightLeak>` transitions for videos classified as "Corporate", "Tech", or "Strategy/Business". The system MUST reserve this effect exclusively for "Lifestyle", "Vlog", "Emotional", or highly cinematic/creative briefs. Corporate videos require clean, formal cuts or subtle fades.
